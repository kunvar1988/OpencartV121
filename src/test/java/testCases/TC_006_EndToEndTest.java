...
public class TC_006_EndToEndTest extends BaseClass
{
	...
	public void endToendTest() throws InterruptedException
	{
		...
		hp.enterProductName(myPropFile.getProperty("searchProductName"));
		hp.clickSearch();

		SearchPage sp=new SearchPage(driver);

		if(sp.isProductExist(myPropFile.getProperty("searchProductName")))
		{
			sp.selectProduct(myPropFile.getProperty("searchProductName"));
			sp.setQuantity("2");
			sp.addToCart();
